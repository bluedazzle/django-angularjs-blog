    ...
    var C = "http://www.w3.org/2000/svg", E = t.document, k = {
        addTheme: function (e, t) {
            ...
            for (c = 0; c < h.length; c++) {
                ...
                var M = null != F.data && 0 === F.data.indexOf(a.domain), D = null != F.dataSrc && 0 === F.dataSrc.indexOf(a.domain);
    ...
    t.f = t.u.extend({
        i: function (a, c, d) {
            ...
            var g = this.b = t.e("div", {id: a.id() + "_temp_flash"}), h = a.id() + "_flash_api", j = a.l, j = t.h.A({
                ...
                loop: j.loop,
                muted: j.muted
            }, c.flashVars), n = t.h.A({wmode: "opaque", bgcolor: "#000000"}, c.params), h = t.h.A({
                id: h,
                name: h,
                "class": "vjs-tech"
            }, c.attributes);
